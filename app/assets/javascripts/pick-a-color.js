    ...
    $.fn.pickAColor = function(options) {
        ...
        var markupAfterInput = function() {
            var $markup = $("<div>").addClass("input-group-append"),
                $dropdownButton = $("<button type='button'>").addClass("btn btn-outline-secondary dropdown-toggle"),
            ...
            if (settings.showAdvanced) {
                ...
                var $previewItem = $("<li>").addClass("preview-item").append($("<span>").addClass("preview-text").text("Preview")),
        ...
        var methods = {
            ...
            initialize: function(index) {
                ...
                if (settings.showHexInput) {
                    $thisParent.prepend('<div class="input-group-prepend"><span class="hex-pound input-group-addoninput-group-text input-group-text">#</span></div>').append(markupAfterInput());
                } else {
        ...
        return this.each(function(index) {
            ...
            methods.executeUnlessScrolled.apply(myElements.colorPreviewButton, [{ "thisFunction": methods.pressPreviewButton, "theseArguments": {} }]);
